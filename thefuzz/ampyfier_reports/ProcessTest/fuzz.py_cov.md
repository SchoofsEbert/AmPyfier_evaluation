...
+	        return 0	#test_dedupe_none_10_str_emp_1
...
-	        p2 = utils.full_process(s2, force_ascii=force_ascii)
	    ...
	    if not utils.validate_string(p1):
+	        return 0	#testWithScorer_str_emp_8_none_8
	    if not utils.validate_string(p2):
+	        return 0	#testWithScorer_str_emp_1_none_17
...
-	        p2 = utils.full_process(s2, force_ascii=force_ascii)
	    ...
	    if not utils.validate_string(p1):
+	        return 0	#testGetBestChoice1_none_1_str_emp_0
	    if not utils.validate_string(p2):
	        return 0
	    ...
	    if len_ratio > 8:
+	        partial_scale = .6	#testGetBestChoice1_str_dbl_0_none_1_str_dbl_0
