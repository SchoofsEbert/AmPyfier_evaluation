...
+	        return 0	#testTokenSetRatio_bool_inv_0
	    if not utils.validate_string(p2):
+	        return 0	#testTokenSetForceAscii_str_emp_1
...
-	        p2 = s2
	    ...
	    if not utils.validate_string(p1):
	        return 0
	    if not utils.validate_string(p2):
+	        return 0	#testQRatioUnicodeString_str_emp_3_none_5
...
-	        p2 = s2
	    ...
	    if not utils.validate_string(p1):
	        return 0
	    if not utils.validate_string(p2):
+	        return 0	#testWRatioUnicodeString_str_emp_3
	    ...
	    if len_ratio > 8:
+	        partial_scale = .6	#testWRatioUnicodeString_str_emp_2_str_chr_0
