...
+	            return 0	#testEmptyStringsScore100_none_0
	        return func(*args, **kwargs)
	    return decorator
...
-	        return s.translate(None, bad_chars)
	...
	def asciidammit(s):
	    if type(s) is str:
	        return asciionly(s)
+	    elif type(s) is unicode:	#testWRatioUnicodeString_none_6_none_0
-	        return asciionly(s.encode('ascii', 'ignore'))
	    else:
+	        return asciidammit(unicode(s))	#testWRatioUnicodeString_none_6_none_0
