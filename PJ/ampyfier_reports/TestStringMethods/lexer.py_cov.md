...
+	    raise Exception('Expected end-of-string quote')	#test_basic_object_str_hlf_0_str_hlf_0
...
+	            raise Exception('Unexpected character: {}'.format(c))	#test_empty_object_str_emp_0_str_chr_0
