...
+	        line = m.group(0)	#test_harmful_links_str_dbl_0_str_hlf_0_none_1
+	        text = m.group(1)	#test_harmful_links_str_dbl_0_str_hlf_0_none_1
+	        key = unikey(m.group(2) or text)	#test_harmful_links_str_dbl_0_str_hlf_0_none_1
+	        def_links = state.get('def_links')	#test_harmful_links_str_dbl_0_str_hlf_0_none_1
+	        if not def_links or key not in def_links:	#test_harmful_links_str_dbl_0_str_hlf_0_none_1
+	            return list(self._scan(line, state, self.ref_link_rules))	#test_harmful_links_str_dbl_0_str_hlf_0_none_1
...
+	        return self.parse_ref_link(m, state)	#test_harmful_links_str_dbl_0_str_hlf_0_none_1
