...
-	        raise NotImplementedError
	    ...
	    def _create_scanner(self, rules):
	        ...
	        if sc:
+	            return sc	#test_unsupported_directive_none_1_str_hlf_0_str_dbl_0
	...
	class Matcher(object):
	    ...
	    def search_pos(self, string, pos):
	        ...
	        if not m:
	            return None
+	        if set(m.group(0)) == {'\n'}:	#test_unsupported_directive_none_1_str_hlf_0
+	            return m.end()	#test_unsupported_directive_none_1_str_hlf_0
-	        return m.start() + 1
	        ...
	        while 1:
	            ...
	            for rule, (name, method) in self.lexicon:
	                ...
	                if match is not None:
	                    ...
	                    if start > last_end:
+	                        yield parse_text(string[last_end:start], state)	#test_code_admonition_str_hlf_0_none_3_none_2
...
-	                        end = token[1]
	                ...
	                if found is None:
	                    break
+	                pos = found	#test_unsupported_directive_none_1_str_hlf_0
