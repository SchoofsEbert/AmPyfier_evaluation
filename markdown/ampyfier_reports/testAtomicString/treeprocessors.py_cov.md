	    ...
	    def __processPlaceholders(self, data, parent, isText=True):
	        ...
	        * parent: Element, which contains processing inline data
	        ...
	        def linkText(text):
	            if text:
	                if result:
+	                    if result[-1][0].tail:	#testString_str_dbl_3
-	                        result[-1][0].tail += text
	                    else:
+	                        result[-1][0].tail = text	#testString_str_dbl_3
	                elif not isText:
	                    if parent.tail:
-	                        parent.tail += text
	                    else:
	                    ...
	                    if parent.text:
+	                        parent.text += text	#testString_str_hlf_0_str_emp_1_str_hlf_2
	                    else:
	                        parent.text = text
	        result = []
	        strartIndex = 0
...
+	                        linkText(node)	#testString_str_hlf_0_str_emp_1_str_hlf_2
+	                        strartIndex = phEndIndex	#testString_str_hlf_0_str_emp_1_str_hlf_2
+	                        continue	#testString_str_hlf_0_str_emp_1_str_hlf_2
...
+	                    startIndex += match.end(0)	#testString_str_hlf_3
+	                    match = None	#testString_str_hlf_3
+	                    continue	#testString_str_hlf_3
	                break
