...
+	        self.reset()	#testBadOutputFormat_amp
...
-	        return self
	    ...
	    def reset(self):
	        ...
	        """
+	        self.htmlStash.reset()	#testBadOutputFormat_amp
+	        self.references.clear()	#testBadOutputFormat_amp
	
+	        for extension in self.registeredExtensions:	#testBadOutputFormat_amp
-	            if hasattr(extension, 'reset'):
-	                extension.reset()
	
+	        return self	#testBadOutputFormat_amp
