...
+	                node, start, end = pattern.handleMatch(match, data)	#testBasicMetaData_str_dbl_1
+	                if start is None or end is None:	#testBasicMetaData_str_dbl_1
+	                    startIndex += match.end(0)	#testBasicMetaData_str_dbl_1
+	                    match = None	#testBasicMetaData_str_dbl_1
+	                    continue	#testBasicMetaData_str_dbl_1
...
+	        if node is None:	#testYamlMetaData_str_dbl_1
+	            return data, True, end	#testYamlMetaData_str_dbl_1
