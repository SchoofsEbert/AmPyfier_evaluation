...
+	        el = None	#testBasicMetaData_str_dbl_1
+	        start = None	#testBasicMetaData_str_dbl_1
+	        end = None	#testBasicMetaData_str_dbl_1
	
+	        for index, item in enumerate(self.PATTERNS):	#testBasicMetaData_str_dbl_1
+	            m1 = item.pattern.match(data, m.start(0))	#testBasicMetaData_str_dbl_1
+	            if m1:	#testBasicMetaData_str_dbl_1
-	                start = m1.start(0)
-	                end = m1.end(0)
-	                el = self.build_element(m1, item.builder, item.tags, index)
-	                break
+	        return el, start, end	#testBasicMetaData_str_dbl_1
	...
	class LinkInlineProcessor(InlineProcessor):
	    ...
	    def handleMatch(self, m, data):
+	        text, index, handled = self.getText(data, m.end(0))	#testYamlMetaData_str_dbl_1
	
+	        if not handled:	#testYamlMetaData_str_dbl_1
+	            return None, None, None	#testYamlMetaData_str_hlf_0_str_hlf_1
	
+	        href, title, index, handled = self.getLink(data, index)	#testYamlMetaData_str_dbl_1
+	        if not handled:	#testYamlMetaData_str_dbl_1
+	            return None, None, None	#testYamlMetaData_str_dbl_1
...
+	        href = ''	#testYamlMetaData_str_dbl_1
+	        title = None	#testYamlMetaData_str_dbl_1
+	        handled = False	#testYamlMetaData_str_dbl_1
	
+	        m = self.RE_LINK.match(data, pos=index)	#testYamlMetaData_str_dbl_1
+	        if m and m.group(1):	#testYamlMetaData_str_dbl_1
...
-	            index = m.end(0)
-	            handled = True
+	        elif m:	#testYamlMetaData_str_dbl_1
...
+	        if title is not None:	#testYamlMetaData_str_dbl_1
-	            title = self.RE_TITLE_CLEAN.sub(' ', dequote(self.unescape(title.strip())))
	
+	        href = self.unescape(href).strip()	#testYamlMetaData_str_dbl_1
	
+	        return href, title, index, handled	#testYamlMetaData_str_dbl_1
	    ...
	    def getText(self, data, index):
	        ...
	        """
+	        bracket_count = 1	#testYamlMetaData_str_dbl_1
+	        text = []	#testYamlMetaData_str_dbl_1
+	        for pos in range(index, len(data)):	#testYamlMetaData_str_dbl_1
+	            c = data[pos]	#testYamlMetaData_str_dbl_1
+	            if c == ']':	#testYamlMetaData_str_dbl_1
+	                bracket_count -= 1	#testYamlMetaData_str_dbl_1
+	            elif c == '[':	#testYamlMetaData_str_dbl_1
+	                bracket_count += 1	#testYamlMetaData_str_hlf_0_str_hlf_1_str_dbl_1
+	            index += 1	#testYamlMetaData_str_dbl_1
+	            if bracket_count == 0:	#testYamlMetaData_str_dbl_1
+	                break	#testYamlMetaData_str_dbl_1
+	            text.append(c)	#testYamlMetaData_str_dbl_1
+	        return ''.join(text), index, bracket_count == 0	#testYamlMetaData_str_dbl_1
...
+	        id, end, handled = self.evalId(data, index, text)	#testYamlMetaData_str_dbl_1
+	        if not handled:	#testYamlMetaData_str_dbl_1
+	            return None, None, None	#testYamlMetaData_str_dbl_1
	
	        # Clean up linebreaks in id
+	        id = self.NEWLINE_CLEANUP_RE.sub(' ', id)	#testYamlMetaData_str_dbl_1
+	        if id not in self.md.references:  # ignore undefined refs	#testYamlMetaData_str_dbl_1
+	            return None, m.start(0), end	#testYamlMetaData_str_dbl_1
...
-	        return self.makeTag(href, title, text), m.start(0), end
	    ...
	    def evalId(self, data, index, text):
	        ...
	        """
+	        m = self.RE_LINK.match(data, pos=index)	#testYamlMetaData_str_dbl_1
+	        if not m:	#testYamlMetaData_str_dbl_1
+	            return None, index, False	#testYamlMetaData_str_dbl_1
	        else:
-	            id = m.group(1).lower()
-	            end = m.end(0)
-	            if not id:
...
+	        return text.lower(), index, True	#testYamlMetaData_str_dbl_1
