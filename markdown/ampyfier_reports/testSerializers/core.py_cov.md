...
+	        except KeyError as e:	#testRegisterSerializer_str_dbl_1
+	            valid_formats = list(self.output_formats.keys())	#testRegisterSerializer_str_dbl_1
+	            valid_formats.sort()	#testRegisterSerializer_str_dbl_1
+	            message = 'Invalid Output Format: "%s". Use one of %s.' \	#testRegisterSerializer_str_dbl_1
	                % (self.output_format,
	                   '"' + '", "'.join(valid_formats) + '"')
+	            e.args = (message,) + e.args[1:]	#testRegisterSerializer_str_dbl_1
+	            raise	#testRegisterSerializer_str_dbl_1
	        return self
...
-	        return False
	    ...
	    def convert(self, source):
	        ...
	        * source: Source text as a Unicode string.
	        ...
	        if not source.strip():
+	            return ''  # a blank unicode string	#testRegisterSerializer_str_emp_0
