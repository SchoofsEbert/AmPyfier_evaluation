...
+	            elif ext is not None:	#testDotNotationExtension_none_1
-	                raise TypeError(
...
+	        except ImportError as e:	#testDotNotationExtension_str_emp_1
+	            message = 'Failed loading extension "%s".' % ext_name	#testDotNotationExtension_str_dbl_1
+	            e.args = (message,) + e.args[1:]	#testDotNotationExtension_str_dbl_1
+	            raise	#testDotNotationExtension_str_dbl_1
...
+	            except AttributeError as e:	#testDotNotationExtension_str_emp_1_str_chr_0_str_dbl_1
+	                message = e.args[0]	#testDotNotationExtension_str_emp_1_str_chr_0_str_dbl_1
+	                message = "Failed to initiate extension " \	#testDotNotationExtension_str_emp_1_str_chr_0_str_dbl_1
	                          "'%s': %s" % (ext_name, message)
+	                e.args = (message,) + e.args[1:]	#testDotNotationExtension_str_emp_1_str_chr_0_str_dbl_1
+	                raise	#testDotNotationExtension_str_emp_1_str_chr_0_str_dbl_1
