...
+	            return None	#testParseChunk_str_emp_2
...
+	                blocks.insert(0, after)	#testParseDocument_str_chr_0
...
-	            blocks.insert(0, postlines)
	...
	class EmptyBlockProcessor(BlockProcessor):
	    ...
	    def run(self, parent, blocks):
+	        block = blocks.pop(0)	#testParseChunk_str_emp_2
+	        filler = '\n\n'	#testParseChunk_str_emp_2
+	        if block:	#testParseChunk_str_emp_2
	            # Starts with empty line
	            # Only replace a single line.
+	            filler = '\n'	#testParseDocument_str_chr_0_str_emp_1
	            # Save the rest for later.
+	            theRest = block[1:]	#testParseDocument_str_chr_0_str_emp_1
+	            if theRest:	#testParseDocument_str_chr_0_str_emp_1
	                # Add remaining lines to master blocks for later.
+	                blocks.insert(0, theRest)	#testParseDocument_str_chr_0_str_emp_1
+	        sibling = self.lastChild(parent)	#testParseChunk_str_emp_2
+	        if (sibling is not None and sibling.tag == 'pre' and	#testParseChunk_str_emp_2
	           len(sibling) and sibling[0].tag == 'code'):
