...
+	            elif ext is not None:	#testComplexSettings_none_1
-	                raise TypeError(
...
+	        ext_name, class_name = ext_name.split(':', 1) if ':' in ext_name else (ext_name, '')	#testComplexSettings_str_emp_1
	
+	        try:	#testComplexSettings_str_emp_1
+	            module = importlib.import_module(ext_name)	#testComplexSettings_str_emp_1
-	            logger.debug(
	                'Successfully imported extension module "%s".' % ext_name
	            )
+	        except ImportError as e:	#testComplexSettings_str_emp_1
+	            message = 'Failed loading extension "%s".' % ext_name	#testComplexSettings_str_dbl_1
+	            e.args = (message,) + e.args[1:]	#testComplexSettings_str_dbl_1
+	            raise	#testComplexSettings_str_dbl_1
...
-	        return False
	    ...
	    def convert(self, source):
	        ...
	        * source: Source text as a Unicode string.
	        ...
	        if not source.strip():
+	            return ''  # a blank unicode string	#testWikilinkWhitespace_str_emp_1
