...
-	                break
	...
	class LinkInlineProcessor(InlineProcessor):
	    ...
	    def handleMatch(self, m, data):
	        ...
	        if not handled:
+	            return None, None, None	#testWikilinkWhitespace_str_dbl_1_str_hlf_1
...
+	            id = m.group(1).lower()	#testWikilinkWhitespace_str_dbl_1
+	            end = m.end(0)	#testWikilinkWhitespace_str_dbl_1
+	            if not id:	#testWikilinkWhitespace_str_dbl_1
-	                id = text.lower()
+	        return id, end, True	#testWikilinkWhitespace_str_dbl_1
