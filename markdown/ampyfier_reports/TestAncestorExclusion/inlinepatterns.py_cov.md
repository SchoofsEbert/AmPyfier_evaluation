...
-	        return util.INLINE_PLACEHOLDER_RE.sub(get_stash, text)
	...
	class AsteriskProcessor(InlineProcessor):
	    ...
	    def build_single(self, m, tag, idx):
	        """Return single tag."""
+	        el1 = etree.Element(tag)	#test_ancestors_tail_str_hlf_1_none_2
+	        text = m.group(2)	#test_ancestors_tail_str_hlf_1_none_2
+	        self.parse_sub_patterns(text, el1, None, idx)	#test_ancestors_tail_str_hlf_1_none_2
+	        return el1	#test_ancestors_tail_str_hlf_1_none_2
...
+	            return self.build_single(m, tags, index)	#test_ancestors_tail_str_hlf_1_none_2
	...
	class LinkInlineProcessor(InlineProcessor):
	    ...
	    def handleMatch(self, m, data):
	        ...
	        if not handled:
+	            return None, None, None	#test_ancestors_str_hlf_2_str_hlf_1
	
	        href, title, index, handled = self.getLink(data, index)
	        if not handled:
+	            return None, None, None	#test_ancestors_none_2_str_hlf_1
...
+	                    if not ignore_matches:	#test_ancestors_str_hlf_1_str_dbl_1_none_2
+	                        bracket_count += 1	#test_ancestors_str_hlf_1_str_dbl_1_none_2
...
+	        id = self.NEWLINE_CLEANUP_RE.sub(' ', id)	#test_ancestors_none_2_str_hlf_1
+	        if id not in self.md.references:  # ignore undefined refs	#test_ancestors_none_2_str_hlf_1
+	            return None, m.start(0), end	#test_ancestors_none_2_str_hlf_1
...
+	        return text.lower(), index, True	#test_ancestors_none_2_str_hlf_1
