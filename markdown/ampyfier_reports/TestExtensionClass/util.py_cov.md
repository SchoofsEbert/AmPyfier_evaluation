...
+	    if not isinstance(value, str):	#testSetConfig_none_1_call_dup_0
+	        if preserve_none and value is None:	#testSetConfig_none_1_call_dup_0
+	            return value	#testSetConfig_none_1_call_dup_0
-	        return bool(value)
+	    elif preserve_none and value.lower() == 'none':	#testSetConfig_call_dup_0_none_1
-	        return None
+	    elif value.lower() in ('true', 'yes', 'y', 'on', '1'):	#testSetConfig_call_dup_0_none_1
-	        return True
+	    elif value.lower() in ('false', 'no', 'n', 'off', '0', 'none'):	#testSetConfig_call_dup_0_none_1
-	        return False
+	    elif fail_on_errors:	#testSetConfig_call_dup_0_none_1
+	        raise ValueError('Cannot parse bool value: %r' % value)	#testSetConfig_call_dup_0_none_1
