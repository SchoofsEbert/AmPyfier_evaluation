...
-	        return string
	...
	class SimpleTextInlineProcessor(InlineProcessor):
	    ...
	    def handleMatch(self, m, data):
+	        return m.group(1), m.start(0), m.end(0)	#testNestedAbbr_str_emp_2_str_hlf_1
...
-	            return None, None, None
	        ...
	        if not handled:
+	            return None, None, None	#testSimpleAbbr_str_emp_2
...
+	        id = self.NEWLINE_CLEANUP_RE.sub(' ', id)	#testSimpleAbbr_str_emp_2
+	        if id not in self.md.references:  # ignore undefined refs	#testSimpleAbbr_str_emp_2
+	            return None, m.start(0), end	#testSimpleAbbr_str_emp_2
...
+	        return text.lower(), index, True	#testSimpleAbbr_str_emp_2
