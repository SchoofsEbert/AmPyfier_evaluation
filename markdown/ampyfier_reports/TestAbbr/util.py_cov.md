...
-	        return '<{}({})>'.format(self.__class__.__name__, list(self))
	    ...
	    def get_index_for_name(self, name):
	        ...
	        """
+	        if name in self:	#testSimpleAbbr_str_dbl_2
+	            self._sort()	#testSimpleAbbr_str_dbl_2
+	            return self._priority.index(	#testSimpleAbbr_str_dbl_2
...
+	            self.deregister(name)	#testSimpleAbbr_str_dbl_2
	        self._is_sorted = False
	    ...
	    def deregister(self, name, strict=True):
	        ...
	        """
+	        try:	#testSimpleAbbr_str_dbl_2
+	            index = self.get_index_for_name(name)	#testSimpleAbbr_str_dbl_2
+	            del self._priority[index]	#testSimpleAbbr_str_dbl_2
+	            del self._data[name]	#testSimpleAbbr_str_dbl_2
-	        except ValueError:
-	            if strict:
-	                raise
