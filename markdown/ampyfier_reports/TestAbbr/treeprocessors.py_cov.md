...
-	                        parent.tail = text
	                    ...
	                    if parent.text:
+	                        parent.text += text	#testNestedAbbr_str_emp_2_str_hlf_1
	                    else:
	                        parent.text = text
	        result = []
	        strartIndex = 0
...
+	                        linkText(node)	#testNestedAbbr_str_emp_2_str_hlf_1
+	                        strartIndex = phEndIndex	#testNestedAbbr_str_emp_2_str_hlf_1
+	                        continue	#testNestedAbbr_str_emp_2_str_hlf_1
...
-	                return data, False, 0
	        ...
	        if node is None:
+	            return data, True, end	#testSimpleAbbr_str_emp_2
