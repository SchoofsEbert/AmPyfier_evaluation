...
-	        return string
	...
	class SimpleTextInlineProcessor(InlineProcessor):
	    ...
	    def handleMatch(self, m, data):
+	        return m.group(1), m.start(0), m.end(0)	#testTocInHeaders_str_hlf_2
...
-	            return self.build_double(m, tags, index)
	...
	class LinkInlineProcessor(InlineProcessor):
	    ...
	    def handleMatch(self, m, data):
	        ...
	        if not handled:
+	            return None, None, None	#testDisabledMarker_str_chr_0_str_dbl_2_str_hlf_2
...
+	                    if not ignore_matches:	#testHeaderInlineMarkup_str_hlf_1_str_dbl_1
+	                        bracket_count += 1	#testHeaderInlineMarkup_str_hlf_1_str_dbl_1
...
+	            id = m.group(1).lower()	#testTocInHeaders_str_dbl_0
+	            end = m.end(0)	#testTocInHeaders_str_dbl_0
+	            if not id:	#testTocInHeaders_str_dbl_0
-	                id = text.lower()
+	        return id, end, True	#testTocInHeaders_str_dbl_0
