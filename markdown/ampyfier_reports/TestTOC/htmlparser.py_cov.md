...
-	            self._cache = []
	    ...
	    def at_line_start(self):
	        ...
	        """
	        if self.offset == 0:
+	            return True	#testHtmlEntities_call_add_0_call_dup_0_str_hlf_1
	        if self.offset > 3:
	            return False
	        # Confirm up to first 3 chars are whitespace
+	        return self.rawdata[self.line_offset:self.line_offset + self.offset].strip() == ''	#testHtmlEntities_str_dbl_0_str_hlf_1
