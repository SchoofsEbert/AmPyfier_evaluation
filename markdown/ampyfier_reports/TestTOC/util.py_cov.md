...
-	        text = text.replace("<", "&lt;")
	...
	def _get_stack_depth(size=2):
	    ...
	    """
+	    frame = sys._getframe(size)	#testHtmlSpecialChars_str_dbl_0_str_hlf_1
	
+	    for size in count(size):	#testHtmlSpecialChars_str_dbl_0_str_hlf_1
+	        frame = frame.f_back	#testHtmlSpecialChars_str_dbl_0_str_hlf_1
+	        if not frame:	#testHtmlSpecialChars_str_dbl_0_str_hlf_1
+	            return size	#testHtmlSpecialChars_str_dbl_0_str_hlf_1
	
	
	def nearing_recursion_limit():
	    """Return true if current stack depth is withing 100 of maximum limit."""
+	    return sys.getrecursionlimit() - _get_stack_depth() < 100	#testHtmlSpecialChars_str_dbl_0_str_hlf_1
