...
+	    for known_format in KNOWN_FORMATS:	#test_cast_date_str_dbl_0
+	        try:	#test_cast_date_str_dbl_0
+	            s = datetime.strptime(s, known_format)	#test_cast_date_str_dbl_0
-	            break
+	        except ValueError as e:	#test_cast_date_str_dbl_0
+	            pass  # Wrong format, keep trying	#test_cast_date_str_dbl_0
+	    return s	#test_cast_date_str_dbl_0
...
+	        except Exception:	#test_cast_date_str_dbl_0
+	            return datetime_parse(s)	#test_cast_date_str_dbl_0
	    else:
...
+	            return WhoisOrg(domain, text)	#test_il_parse_str_hlf_27
...
+	        elif domain.endswith('.app'):	#test_com_expiration_none_2_str_hlf_1
-	            return WhoisApp(domain, text)
+	        elif domain.endswith('.money'):	#test_com_expiration_none_2_str_hlf_1
-	            return WhoisMoney(domain, text)
+	        elif domain.endswith('.cl'):	#test_com_expiration_none_2_str_hlf_1
-	            return WhoisCl(domain, text)
+	        elif domain.endswith('.ar'):	#test_com_expiration_none_2_str_hlf_1
-	            return WhoisAr(domain, text)
+	        elif domain.endswith('.by'):	#test_com_expiration_none_2_str_hlf_1
-	            return WhoisBy(domain, text)
+	        elif domain.endswith('.cr'):	#test_com_expiration_none_2_str_hlf_1
-	            return WhoisCr(domain, text)
+	        elif domain.endswith('.do'):	#test_com_expiration_none_2_str_hlf_1
-	            return WhoisDo(domain, text)
+	        elif domain.endswith('.jobs'):	#test_com_expiration_none_2_str_hlf_1
-	            return WhoisJobs(domain, text)
+	        elif domain.endswith('.lat'):	#test_com_expiration_none_2_str_hlf_1
-	            return WhoisLat(domain, text)
+	        elif domain.endswith('.pe'):	#test_com_expiration_none_2_str_hlf_1
-	            return WhoisPe(domain, text)
+	        elif domain.endswith('.ro'):	#test_com_expiration_none_2_str_hlf_1
-	            return WhoisRo(domain, text)
+	        elif domain.endswith('.sa'):	#test_com_expiration_none_2_str_hlf_1
-	            return WhoisSa(domain, text)
+	        elif domain.endswith('.tw'):	#test_com_expiration_none_2_str_hlf_1
-	            return WhoisTw(domain, text)
+	        elif domain.endswith('.tr'):	#test_com_expiration_none_2_str_hlf_1
-	            return WhoisTr(domain, text)
+	        elif domain.endswith('.ve'):	#test_com_expiration_none_2_str_hlf_1
-	            return WhoisVe(domain, text)
+	        elif domain.endswith('.ua'):	#test_com_expiration_none_2_str_hlf_1
-	            return WhoisUA(domain, text)
+	        elif domain.endswith('.kz'):	#test_com_expiration_none_2_str_hlf_1
-	            return WhoisKZ(domain, text)
+	        elif domain.endswith('.ir'):	#test_com_expiration_none_2_str_hlf_1
-	            return WhoisIR(domain, text)
+	        elif domain.endswith('.中国'):	#test_com_expiration_none_2_str_hlf_1
-	            return WhoisZhongGuo(domain, text)
+	        elif domain.endswith('.website'):	#test_com_expiration_none_2_str_hlf_1
-	            return WhoisWebsite(domain, text)
+	        elif domain.endswith('.sg'):	#test_com_expiration_none_2_str_hlf_1
-	            return WhoisSG(domain, text)
+	        elif domain.endswith('.ml'):	#test_com_expiration_none_2_str_hlf_1
-	            return WhoisML(domain, text)
+	        elif domain.endswith('.ooo'):	#test_com_expiration_none_2_str_hlf_1
-	            return WhoisOOO(domain, text)
+	        elif domain.endswith('.market'):	#test_com_expiration_none_2_str_hlf_1
-	            return WhoisMarket(domain, text)
	        else:
+	            return WhoisEntry(domain, text)	#test_com_expiration_none_2_str_hlf_1
...
-	            WhoisEntry.__init__(self, domain, text)
	...
	class WhoisOrg(WhoisEntry):
	    ...
	    def __init__(self, domain, text):
+	        if text.strip() == 'NOT FOUND':	#test_il_parse_str_hlf_27
-	            raise PywhoisError(text)
	        else:
+	            WhoisEntry.__init__(self, domain, text)	#test_il_parse_str_hlf_27
