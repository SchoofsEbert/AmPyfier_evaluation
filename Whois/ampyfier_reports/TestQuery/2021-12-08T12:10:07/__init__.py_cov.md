...
+	        r = subprocess.Popen([executable, domain], stdout=subprocess.PIPE)	#test_simple_ascii_domain_call_add_0
...
+	                second_order_tld = '.'.join([split_url[-2], split_url[-1]])	#test_simple_ascii_domain_call_add_0
+	                if not second_order_tld.encode('utf-8') in suffixes:	#test_simple_ascii_domain_call_add_0
+	                    break	#test_simple_ascii_domain_call_add_0
	            else:
	                break
