...
+	        elif domain.endswith('.info'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisInfo(domain, text)
+	        elif domain.endswith('.su'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisSu(domain, text)
+	        elif domain.endswith('si'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisSi(domain, text)
+	        elif domain.endswith('.kg'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisKg(domain, text)
+	        elif domain.endswith('.io'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisIo(domain, text)
+	        elif domain.endswith('.biz'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisBiz(domain, text)
+	        elif domain.endswith('.mobi'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisMobi(domain, text)
+	        elif domain.endswith('.ch'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisChLi(domain, text)
+	        elif domain.endswith('.li'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisChLi(domain, text)
+	        elif domain.endswith('.id'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisID(domain, text)
+	        elif domain.endswith('.sk'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisSK(domain, text)
+	        elif domain.endswith('.se'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisSe(domain, text)
+	        elif domain.endswith('no'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisNo(domain, text)
+	        elif domain.endswith('.nu'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisSe(domain, text)
+	        elif domain.endswith('.is'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisIs(domain, text)
+	        elif domain.endswith('.dk'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisDk(domain, text)
+	        elif domain.endswith('.it'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisIt(domain, text)
+	        elif domain.endswith('.mx'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisMx(domain, text)
+	        elif domain.endswith('.ai'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisAi(domain, text)
+	        elif domain.endswith('.il'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisIl(domain, text)
+	        elif domain.endswith('.in'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisIn(domain, text)
+	        elif domain.endswith('.cat'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisCat(domain, text)
+	        elif domain.endswith('.ie'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisIe(domain, text)
+	        elif domain.endswith('.nz'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisNz(domain, text)
+	        elif domain.endswith('.space'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisSpace(domain, text)
+	        elif domain.endswith('.lu'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisLu(domain, text)
+	        elif domain.endswith('.cz'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisCz(domain, text)
+	        elif domain.endswith('.online'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisOnline(domain, text)
+	        elif domain.endswith('.cn'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisCn(domain, text)
+	        elif domain.endswith('.app'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisApp(domain, text)
+	        elif domain.endswith('.money'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisMoney(domain, text)
+	        elif domain.endswith('.cl'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisCl(domain, text)
+	        elif domain.endswith('.ar'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisAr(domain, text)
+	        elif domain.endswith('.by'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisBy(domain, text)
+	        elif domain.endswith('.cr'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisCr(domain, text)
+	        elif domain.endswith('.do'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisDo(domain, text)
+	        elif domain.endswith('.jobs'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisJobs(domain, text)
+	        elif domain.endswith('.lat'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisLat(domain, text)
+	        elif domain.endswith('.pe'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisPe(domain, text)
+	        elif domain.endswith('.ro'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisRo(domain, text)
+	        elif domain.endswith('.sa'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisSa(domain, text)
+	        elif domain.endswith('.tw'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisTw(domain, text)
+	        elif domain.endswith('.tr'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisTr(domain, text)
+	        elif domain.endswith('.ve'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisVe(domain, text)
+	        elif domain.endswith('.ua'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisUA(domain, text)
+	        elif domain.endswith('.kz'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisKZ(domain, text)
+	        elif domain.endswith('.ir'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisIR(domain, text)
+	        elif domain.endswith('.中国'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisZhongGuo(domain, text)
+	        elif domain.endswith('.website'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisWebsite(domain, text)
+	        elif domain.endswith('.sg'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisSG(domain, text)
+	        elif domain.endswith('.ml'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisML(domain, text)
+	        elif domain.endswith('.ooo'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisOOO(domain, text)
+	        elif domain.endswith('.market'):	#test_simple_ascii_domain_str_hlf_0
-	            return WhoisMarket(domain, text)
	        else:
+	            return WhoisEntry(domain, text)	#test_simple_ascii_domain_str_hlf_0
...
+	            raise PywhoisError(text)	#test_unicode_domain_and_tld_str_dbl_0_call_add_0_none_1
	        else:
	            WhoisEntry.__init__(self, domain, text, self.regex)
