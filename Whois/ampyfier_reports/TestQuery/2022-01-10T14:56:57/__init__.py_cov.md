...
+	        except socket.herror as e:	#test_ipv6_str_dbl_0_str_hlf_1
+	            pass	#test_ipv6_str_dbl_0_str_hlf_1
	        else:
...
+	                second_order_tld = '.'.join([split_url[-2], split_url[-1]])	#test_simple_ascii_domain_str_hlf_0
+	                if not second_order_tld.encode('utf-8') in suffixes:	#test_simple_ascii_domain_str_hlf_0
+	                    break	#test_simple_ascii_domain_str_hlf_0
	            else:
	                break
